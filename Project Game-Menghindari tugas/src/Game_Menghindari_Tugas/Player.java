...
public class Player extends GameObject {
    ...
    private void collision(){
        ...
        if (objectSementara.getid() == ID.Kalkulus || objectSementara.getid() == ID.Fisdas || objectSementara.getid() == ID.Pdp || objectSementara.getid() == ID.Laprak || objectSementara.getid() == ID.daspro) {
